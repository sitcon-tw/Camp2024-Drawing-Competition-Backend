...
def judge_logic(image_url, result_path, word_count, execution_time):
    ...
    max_word_count = 1000  # Example value, should be adjusted
    min_execution_time = 0.1  # Example value, should be adjusted
    max_execution_time = 10.0  # Example value, should be adjusted
...
def run_code(code_path, image_url, result_path):
    ...
    score = judge_logic(image_url, result_path, word_count, execution_time)
...
def judge_submission(code_path, image_url, result_path):
    ...
    score = run_code(code_path, image_url, result_path)
